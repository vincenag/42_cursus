...
/*   Updated: 2023/12/22 21:51:19 by agvincen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_philo
{
	...
	pthread_mutex_t	last_meal_mutex;	// mutex para el tiempo de la ultima comida
	t_table				*table;
}						t_philo;
typedef struct s_table
{
	...
	int				x_done;				// numero de filosofs que han acabado de comer
